...
${DOCKER_IMAGE} \
sh -c "cd /workspace/kbd_firmware && kb=crkbd kr=rev4_1/standard km=via make qmk-compile && cp *.uf2 /firmware"

rclone copy ~/keyboard/firmware/*.uf2 dropbox:Keyboard/firmware
