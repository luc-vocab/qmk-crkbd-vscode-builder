...
#define __KEYNAV_L2__  KC_TRNS,        MO(KEYSEL),  KC_TRNS,       RSFT(KC_TAB),  KC_TAB,              KC_TRNS
#define __KEYNAV_L3__  KC_TRNS,        KC_TRNS,     KC_TRNS,       KC_TRNS,       QK_CAPS_WORD_TOGGLE, KC_TRNS
